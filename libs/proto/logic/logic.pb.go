...
func (m *BroadCastRoom) Reset()         { *m = BroadCastRoom{} }
func (m *BroadCastRoom) String() string { return proto1.CompactTextString(m) }
...
func (m *BroadCastRoom) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *BroadCastRoom) MarshalTo(data []byte) (n int, err error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *BroadCastRoom) Size() (n int) {
	var l int
	_ = l
	if m.RoomId != 0 {
...
func (m *BroadCastRoom) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		var wire uint64
