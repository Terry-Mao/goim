...
func (m *PushMsgArg) String() string { return proto1.CompactTextString(m) }
...
func (m *PushMsgsArg) String() string { return proto1.CompactTextString(m) }
...
func (m *PushMsgsReply) String() string { return proto1.CompactTextString(m) }
...
func (m *MPushMsgArg) String() string { return proto1.CompactTextString(m) }
...
func (m *MPushMsgReply) String() string { return proto1.CompactTextString(m) }
...
func (m *MPushMsgsArg) String() string { return proto1.CompactTextString(m) }
...
func (m *MPushMsgsReply) String() string { return proto1.CompactTextString(m) }
